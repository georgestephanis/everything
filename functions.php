<?php
/**
 * Everything theme functions and definitions.
 *
...
namespace Everything\Functions;
...
function on_after_setup_theme() {
	...
	\add_theme_support( 'starter-content', \Everything\StarterContent\get_starter_content() );
}
